...
def draw_fruit(screen, fruit, unit):
    ...
    screen.blit(fruit.selected_fruit, (fruit_col*unit ,fruit_row*unit))
...
def load_images(map_width, map_height, unit):
    ...
    blueberry_img = pygame.transform.scale(blueberry_img, (50, 50))
    ...
    grapes_img = pygame.transform.scale(grapes_img, (50, 50))
    ...
    avacado_img = pygame.transform.scale(avacado_img, (50, 50))
    ...
    rasberry_img = pygame.transform.scale(rasberry_img, (50, 50))

    strawberry_img = pygame.image.load('images/fruits/strawberry.jpg').convert_alpha()
    strawberry_img = pygame.transform.scale(strawberry_img, (50, 50))

    tomato_img = pygame.image.load('images/fruits/tomato.jpg').convert_alpha()
    tomato_img = pygame.transform.scale(tomato_img, (50, 50))
    
    coconut_img = pygame.image.load('images/fruits/coconut.jpg').convert_alpha()
    coconut_img = pygame.transform.scale(coconut_img, (50, 50))
